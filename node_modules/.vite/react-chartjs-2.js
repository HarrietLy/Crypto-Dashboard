import {
  ...
  RadarController,
  ScatterController
} from "./chunk-73JRBYPC.js";
import {
  require_react
} from "./chunk-BSG7XTX5.js";
import {
  __objRest,
  __spreadValues,
  __toModule
...
function ChartComponent(param, ref) {
  let _a = param, { height = 150, width = 300, redraw = false, datasetIdKey, type, data, options, plugins = [], fallbackContent } = _a, props = __objRest(_a, ["height", "width", "redraw", "datasetIdKey", "type", "data", "options", "plugins", "fallbackContent"]);
